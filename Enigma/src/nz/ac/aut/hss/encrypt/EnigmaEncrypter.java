...
public class EnigmaEncrypter
{
    ...
    //Number of routers
    private final int NUMBER_OF_ROTOR = 3; //Not impelemented yet
    //Bit lazy
    private Scanner keyboard = new Scanner(System.in);
    
    // Values for three rotors
    private char[] innerRotor =  {' ','G','N','U','A','H','O','V','B','I','P','W','C','J','Q','X','D','K','R','Y','E','L','S','Z','F','M','T'};
    private char[] middleRotor = {' ','E','J','O','T','Y','C','H','M','R','W','A','F','K','P','U','Z','D','I','N','S','X','B','G','L','Q','V'};
    private char[] outerRotor =  {' ','B','D','F','H','J','L','N','P','R','T','V','X','Z','A','C','E','G','I','K','M','O','Q','S','U','W','Y'};
    ...
    {
        EnigmaEncrypter enigmaInstance = new EnigmaEncrypter();        
        enigmaInstance.promptStartingRotorValues();
        char[] encodedText = enigmaInstance.encodeText();
